...
#include "Libs\foot.au3"
 ...
 $Label_1=GuiCtrlCreateLabel(" оличество прогонов теста:", 10, 15, 150, 15)
;GUICtrlSetBkColor(-1, 0x00ff00)
$TestRepeat = GUICtrlCreateInput ("5",300, 15, 40, 20)
$updown = GUICtrlCreateUpdown($TestRepeat)

GuiCtrlCreateLabel("”читываетс€ следующа€ активность системы:", 10, 40, 310, 15 )
$cpu_activity=GUICtrlCreateCheckbox(" «агруженность процессора", 10, 70, 170, 20)



$hdd_activity=GUICtrlCreateCheckbox(" ƒискова€ подсистема", 10, 100, 170, 20)




GuiCtrlCreateLabel("Ќажми F1 дл€ справки", 200, 120, 150, 15, $SS_RIGHT)
;GUICtrlSetBkColor(-1, 0x00ff00)
GUICtrlSetColor(-1, 0xeb0000)

$Button_Start=GuiCtrlCreateButton("ѕоехали", 10, 140, 100, 30)
GUICtrlSetState ($Button_Start, $GUI_FOCUS )
$Button_Stop=GuiCtrlCreateButton("Ќехочу", 250, 140, 100, 30)
...
While 1
   ...
   Case $msg =	$TestRepeat
		...
		If 	GUICtrlRead($TestRepeat)<2 Then
			MsgBox(1, "ѕредупреждение", " оличество прогонов теста должно быть больше одного")
		...
		; Checking copied files
		 While $t <= Ubound($FilesArray)-1
			...
			If $FilesArray[$t]==1 Then 
			   $t=$t+1
			Else 
			   MsgBox(0, "Sad News", "Ќе все файлы переписались")
	...
	Else
		...
		MsgBox (0, "Sad news", "Ќе могу создать директорию")
	  Exit
	  EndIf
